    ...
    <View className="flex-1 bg-white">
      <Image style={{borderBottomLeftRadius: 50, borderBottomRightRadius: 50}} source={require('../assets/images/background.png')}
        ...
        <SafeAreaView>
            ...
            <View className="mx-4 mt-1 space-y-3 h-59">
                <Animatable.Text
                animation="slideInUp"
                ...
                delay={100} animation="slideInUp"
                 className="text-gray-600 tracking-wider text-xs mb-4">{item.desc}</Animatable.Text>
            </View>
            {/* add to cart button */}
            <View className="mx-4 flex-row justify-between items-center">
                <Animatable.Text delay={100} animation="slideInLeft" className="text-2xl font-semibold text-gray-800">
                    ${item.price}
                </Animatable.Text>
                <Animatable.View delay={100} animation="slideInRight">
                    <TouchableOpacity className="bg-gray-800 p-4 px-8 rounded-2xl">
