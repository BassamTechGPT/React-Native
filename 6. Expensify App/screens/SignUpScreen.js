    ...
    <View className="mt-5">
      <View className="flex justify-between h-full mx-4">
        <View className="relative mt-5">
          ...
          <Text className={`${colors.heading} mx-10 text-xl font-bold text-center`}>Sign Up</Text>
...

          {
            userLoading ? (<Loading />) : (
              <TouchableOpacity onPress={handleSubmit} style={{ backgroundColor: colors.button }} className="my-8 rounded-full p-3 shadow-sm mx-2">
                {/* <TouchableOpacity onPress={() => { handleSubmit(); setPortalSnackbarVisible(true); }} style={{ backgroundColor: colors.button }} className="my-8 rounded-full p-3 shadow-sm mx-2"> */}
